...
注册完成后搜索 `ncwss.github.io` 进入[我的仓库](https://github.com/ncwss/ncwss.github.io)

点击右上角的 **Fork** 将我的仓库拉倒你的账号下

稍等一下，点击刷新，你会看到**Fork**了成功的页面

![](https://drh2acu5z204m.cloudfront.net/items/221y2J3U443G2q131p1C/IMG_20181003_230052.png?X-CloudApp-Visitor-Id=3173679&v=9121ead1)
...
![](https://drh2acu5z204m.cloudfront.net/items/2M2R2h362Q3T021c2M3L/IMG_20181003_230119.png?X-CloudApp-Visitor-Id=3173679&v=cccc89a5)

<p id = "Rename"></p>
修改仓库名为 `你的Github账号名.github.io`，然后 Rename

![](https://drh2acu5z204m.cloudfront.net/items/1E0u013A2j3M291f2Q3a/github3.png?X-CloudApp-Visitor-Id=3173679&v=7b57bc89)

这时你在在浏览器中输入 `你的Github账号名.github.io` 例如:ncwss.github.io`
...
这里还需要你在CNAME 中将域名改成你自己的域名（这样这个博客只属于你了）。
# 自定义域名
...
```
# Site settings
title: Mr Zheng's Blog    				  	#你博客的标题
SEOTitle: 郑先生的博客 | Mr Zheng's Blog    	 #显示在浏览器上搜索的时候显示的标题
header-img: img/post-bg-rwd.jpg  	#显示在首页的背景图片
email: You@gmail.com	
description: "Mr Zheng's Blog"  			 #网站介绍
keyword: "机器人, linux" #关键词
url: "https://ncwss.github.io"          # 这个就是填写你的博客地址
baseurl: ""      # 这个我们不用填写
...
Mac 上的图床神器：cloudapp(windows)  

直接在goole上可以搜索到！很简单，但是巨慢！！！！！（所以这里就不贴图了）

使用方法很简单，可以直接利用内部搜索引擎，或者是利用本地上传（屏幕正中央蓝色框，非常明显）。
